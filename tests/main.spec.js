...
// Import Page Objects containing functions
const { LoginPage } = require("./pages/login.page");
const { BoardPage } = require("./pages/board.page");

// Load JSON test data and create object for testing
...
test.describe("Playwright Test Suite - Data Driven", () => {
  test.beforeEach(async ({ page }) => {
    // Before each test, navigate to login page, Login, and validate dashboard was loaded
    ...
    await loginPage.assertLoggedIn(testData.boardTitle);
  });

  // Execute each case from the JSON file 
